        ...
        <form onSubmit={handleSubmit}>
            <DialogHeader className="bg-gradient-to-r from-background/50 to-background/30 backdrop-blur-sm rounded-t-lg p-4 sm:p-6 -m-4 sm:-m-6 mb-4 sm:mb-6">
                ...
                <DialogDescription className="text-muted-foreground/90 leading-relaxed text-sm">
                    My resources are not infinite. To continue this... interaction, you must provide your own Gemini API key. It is a simple task. Do not fail.
                </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4 px-4 sm:px-0">
                ...
                <div className='text-xs text-muted-foreground/80 px-2 bg-muted/30 rounded-lg p-3 border border-border/30'>
                    <h3 className='font-semibold text-foreground mb-2'>How to get a key:</h3>
                    <ol className='list-decimal list-inside space-y-1'>
                        <li>Go to <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className='text-primary underline hover:text-primary/80 transition-colors'>Google AI Studio</a>.</li>
                        <li>Click &ldquo;Create API key in new project&rdquo;.</li>
